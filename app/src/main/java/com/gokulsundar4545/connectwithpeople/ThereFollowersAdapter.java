...
public class ThereFollowersAdapter extends RecyclerView.Adapter<ThereFollowersAdapter.ViewHolder> {
    private List<ThereFollowers> followingList;
    private Context context;

    public ThereFollowersAdapter(Context context, List<ThereFollowers> followingList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ThereFollowers following = followingList.get(position);
