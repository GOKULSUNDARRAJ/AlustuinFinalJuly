...
public class VideoFragmentforstoryedit extends Fragment implements VideoAdapterforstoryAdapter.OnVideoClickListener {
    ...
    private VideoAdapterforstoryAdapter videoAdapter;
    ...
    private void displayVideoFiles() {
        ...
        videoAdapter = new VideoAdapterforstoryAdapter(getContext(), videoFiles, this);
