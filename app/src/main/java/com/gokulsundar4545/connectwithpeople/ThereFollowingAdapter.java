...
public class ThereFollowingAdapter extends RecyclerView.Adapter<ThereFollowingAdapter.ViewHolder> {
    private List<ThereFollowing> followingList;
    private Context context;

    public ThereFollowingAdapter(Context context, List<ThereFollowing> followingList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ThereFollowing following = followingList.get(position);
