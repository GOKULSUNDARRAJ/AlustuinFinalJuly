...
public class ImagecoverAdapter extends RecyclerView.Adapter<ImagecoverAdapter.ViewHolder> {
    ...
    public ImagecoverAdapter(Context context, List<String> imagePaths, OnImageClickListener clickListener) {
