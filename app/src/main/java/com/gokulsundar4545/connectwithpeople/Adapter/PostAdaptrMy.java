...
import com.gokulsundar4545.connectwithpeople.databinding.DashboardRvOptionBinding;
...
public class PostAdaptrMy extends RecyclerView.Adapter<PostAdaptrMy.viewHolder> {

    ArrayList<Post> list;
    Context context;

    public PostAdaptrMy(ArrayList<Post> list, Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.dashboard_rv_option,parent,false);
    ...
    public void onBindViewHolder(@NonNull  viewHolder holder, int position) {
        ...
        holder.binding.menubar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout shareoption1=dialog.findViewById(R.id.deleteLayou1);

                      shareoption1.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        DashboardRvOptionBinding binding;
        public viewHolder(@NonNull  View itemView) {
            super(itemView);

            binding= DashboardRvOptionBinding.bind(itemView);
