...
public class UserAdapterLike extends RecyclerView.Adapter<UserAdapterLike.viewHolder> {
    ...
    public UserAdapterLike(Context context, ArrayList<User> list, boolean ischat) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.user_sample_like,parent,false);

        return new viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull  UserAdapterLike.viewHolder holder, int position) {
