...
public class GalleryAdapterforstoryedit extends RecyclerView.Adapter<GalleryAdapterforstoryedit.ViewHolder> {
    ...
    public GalleryAdapterforstoryedit(Context context, List<Uri> imagePaths, OnImageClickListener clickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            if (clickListener != null) {
                clickListener.onImageClick(imageUri.toString());
            }
        });
    }
