...
public class VideoAdapterforstoryAdapter extends RecyclerView.Adapter<VideoAdapterforstoryAdapter.VideoViewHolder> {
    ...
    public VideoAdapterforstoryAdapter(Context context, List<File> videoFiles, OnVideoClickListener listener) {
