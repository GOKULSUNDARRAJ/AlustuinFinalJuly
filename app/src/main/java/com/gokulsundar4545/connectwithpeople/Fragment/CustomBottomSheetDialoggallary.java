...
public class CustomBottomSheetDialoggallary extends BottomSheetDialogFragment implements GalleryAdapter.OnImageClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button btnDone = view.findViewById(R.id.down); // Assuming you have a "Done" button
