...
import com.gokulsundar4545.connectwithpeople.Adapter.GalleryAdapter2;
...
import com.gokulsundar4545.connectwithpeople.StoryImageActivity;

import java.util.List;

public class GalleryFragment2 extends Fragment implements GalleryAdapter2.OnImageClickListener {
    ...
    private void loadGallery() {
        ...
        GalleryAdapter2 galleryAdapter = new GalleryAdapter2(getContext(), imagePaths, this); // Pass 'this' as the listener
    ...
    private void handleDoneButtonClick() {
        if (selectedImageUrl != null) {
            ...
            Intent intent = new Intent(getActivity(), StoryImageActivity.class);
            intent.putExtra("image_url2", selectedImageUrl);
